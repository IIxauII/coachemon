...
// One line per option — `★ Swamp 72` — with the encounter type mix, the species met most, the trainers met, every
// reason (the gym leader ahead among them), the best catch, the wild boss on the tenth wave and where the biome
// leads next.
import { FS, badge, bar, closed, dim, h, line, mon, tab } from "./90-render.js";
