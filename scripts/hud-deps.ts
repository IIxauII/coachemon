...
export const HUD_DEPS = {
   ...
   * twelve common and eight great encounters does from its source file — so every
   * encounter const, the helpers and tuning constants its outcome is spelled from,
   * and the phases that fork the RNG are the dependency. A moved fork offset
