...
- **Bounded by a press cap.** Hitting the cap returns `status: "stuck"` with the diagnostic rather than pressing forever. The cap's value is #13's to set.
