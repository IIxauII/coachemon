 ...
 * function arguments (§10.5), the extension's page script calls it directly. `modes` carries the generated mode enums
 * in, since a stringified handler cannot import them (#164); they reach every handler as `L.m` and `L.sm`.
 *
