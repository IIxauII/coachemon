...
import { BUILD_PLACEHOLDER, buildId, hudScript, notices, stamp } from "./src/build/artifact.ts";
...
/** Every `.js` under `dir`, so the build id reaches whichever chunks the bundler produced. */
...
export default defineConfig({
  ...
  zip: {
    ...
    excludeSources: ["extension/.output/**", "extension/node_modules/**"],
  },
  hooks: {
    /**
